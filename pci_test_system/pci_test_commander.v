//===========================================================================
// $Id: pci_test_commander.v,v 1.6 2001-06-20 11:25:46 bbeaver Exp $
//
...
task CONFIG_READ;
  ...
  input  [2:0] target_termination;
  begin
    DO_REF (name[79:0], master_number[2:0], address[31:0],
              `PCI_COMMAND_CONFIG_READ, data[31:0], `Test_All_Bytes,
...
task MEM_READ;
  ...
  begin
    DO_REF (name[79:0], master_number[2:0], address[31:0],
              `PCI_COMMAND_MEMORY_READ, data[31:0], `Test_All_Bytes,
              size[3:0], `Test_No_Addr_Perr, `Test_No_Data_Perr,
              master_wait_states[7:0], target_wait_states[7:0],
              target_devsel_speed[1:0], `Test_Fast_B2B,
              target_termination[2:0], `Test_Expect_No_Master_Abort);
...
task MEM_WRITE;
  ...
  begin
    DO_REF (name[79:0], master_number[2:0], address[31:0],
              `PCI_COMMAND_MEMORY_WRITE, data[31:0], `Test_All_Bytes,
              size[3:0], `Test_No_Addr_Perr, `Test_No_Data_Perr,
              master_wait_states[7:0], target_wait_states[7:0],
              target_devsel_speed[1:0], `Test_Fast_B2B,
              target_termination[2:0], `Test_Expect_No_Master_Abort);
...
// Turn on the device before doing memory references
    ...
    CONFIG_WRITE ("CFG_W_BAR1", Master_ID[2:0],
               Target_Config_Addr[31:0] + 32'h14, Target_Base_Addr_1[31:0],
               `Test_One_Word, `Test_No_Master_WS, `Test_No_Target_WS,
               `Test_Devsel_Medium, `Test_Target_Normal_Completion);
    CONFIG_WRITE ("CFG_W_CMD ", Master_ID[2:0],
               Target_Config_Addr[31:0] + 32'h04,
               `CONFIG_CMD_FB2B_EN
...
task vary_one_paramater_at_a_time;
  ...
  input  [31:0] Target_Config_Addr_A;
  input  [31:0] Target_Base_Addr_A;
  input  [2:0] Master_ID_B;
  input  [31:0] Target_Config_Addr_B;
  input  [31:0] Target_Base_Addr_B;
  begin
// Disable PERR En register and SERR En register
    CONFIG_WRITE ("CFG_W_NOPS", Master_ID_A[2:0],
               Target_Config_Addr_A[31:0] + 32'h04,
               `CONFIG_CMD_FB2B_EN
                     | `CONFIG_CMD_MASTER_EN | `CONFIG_CMD_TARGET_EN,
               `Test_One_Word, `Test_No_Master_WS, `Test_No_Target_WS,
               `Test_Devsel_Medium, `Test_Target_Normal_Completion);
    CONFIG_WRITE ("CFG_W_NOPS", Master_ID_B[2:0],
               Target_Config_Addr_B[31:0] + 32'h04,
               `CONFIG_CMD_FB2B_EN
                     | `CONFIG_CMD_MASTER_EN | `CONFIG_CMD_TARGET_EN,
               `Test_One_Word, `Test_No_Master_WS, `Test_No_Target_WS,
               `Test_Devsel_Medium, `Test_Target_Normal_Completion);
...
// Do address and data parity reference
    ...
    DO_REF ("CFG_R_SERR", Master_ID_A[2:0], Target_Config_Addr_A[31:0] + 32'h20,
    ...
    DO_REF ("CFG_R_PERR", Master_ID_A[2:0], Target_Config_Addr_A[31:0] + 32'h20,
               `PCI_COMMAND_CONFIG_READ, 32'h00000000, `Test_All_Bytes,  // expect error
    ...
    DO_REF ("CFG_W_PERR", Master_ID_A[2:0], Target_Config_Addr_A[31:0] + 32'h20,
...
// Do read causing Target Abort
    CONFIG_READ ("CFG_R_NOPS", Master_ID_A[2:0],
               Target_Config_Addr_A[31:0] + 32'h04, 32'h00000000,
               `Test_One_Word, `Test_No_Master_WS, `Test_No_Target_WS,
...
// Write from Master 0 to Target 1, from Master 1 to Target 0, read back
        MEM_WRITE ("MMS_W_SCAN", Master_ID_A[2:0], Target_Base_Addr_A[31:0],
               32'h12345678, `Test_One_Word,
               `Test_No_Master_WS, `Test_No_Target_WS,
               `Test_Devsel_Medium, `Test_Target_Normal_Completion);
        MEM_WRITE ("MMS_W_SCAN", Master_ID_B[2:0], Target_Base_Addr_B[31:0],
               32'h87654321, `Test_One_Word,
               `Test_No_Master_WS, `Test_No_Target_WS,
               `Test_Devsel_Medium, `Test_Target_Normal_Completion);
        MEM_READ  ("MMS_R_SCAN", Master_ID_A[2:0], Target_Base_Addr_A[31:0],
               32'h12345678, `Test_One_Word,
               `Test_No_Master_WS, `Test_No_Target_WS,
               `Test_Devsel_Medium, `Test_Target_Normal_Completion);
        MEM_READ  ("MMS_R_SCAN", Master_ID_B[2:0], Target_Base_Addr_B[31:0],
               32'h87654321, `Test_One_Word,
               `Test_No_Master_WS, `Test_No_Target_WS,
               `Test_Devsel_Medium, `Test_Target_Normal_Completion);
...
// Byte Masks
        MEM_WRITE ("MMS_W_SCAN", Master_ID_A[2:0], Target_Base_Addr_A[31:0],
               ...
               `Test_No_Master_WS, `Test_No_Target_WS,
               `Test_Devsel_Medium, `Test_Target_Normal_Completion);
        DO_REF ("MMS_W_SCAN", Master_ID_A[2:0], Target_Base_Addr_A[31:0],
...
// Master Transfer Length (1,2)
        ...
        MEM_WRITE ("MMS_W_SCAN", Master_ID_A[2:0],
               Target_Base_Addr_A[31:0] + 32'h00000004,
               32'hFFFFFFFF, `Test_One_Word,
               `Test_No_Master_WS, `Test_No_Target_WS,
               `Test_Devsel_Medium, `Test_Target_Normal_Completion);
        MEM_WRITE ("MMS_W_SCAN", Master_ID_A[2:0],
               Target_Base_Addr_A[31:0] + 32'h00000008,
               32'hFFFFFFFF, `Test_One_Word,
               `Test_No_Master_WS, `Test_No_Target_WS,
               `Test_Devsel_Medium, `Test_Target_Normal_Completion);
        MEM_WRITE ("MMS_W_SCAN", Master_ID_A[2:0], Target_Base_Addr_A[31:0],
        ...
        MEM_READ  ("MMS_R_SCAN", Master_ID_A[2:0],
               Target_Base_Addr_A[31:0],  // expect error
               32'h01020304, `Test_Two_Words,
               `Test_No_Master_WS, `Test_No_Target_WS,
               `Test_Devsel_Medium, `Test_Target_Normal_Completion);
...
// Target DEVSEL speed (0,1,2,3)
        ...
        MEM_WRITE ("MMS_W_SCAN", Master_ID_A[2:0],
               ...
               `Test_Devsel_Medium, `Test_Target_Normal_Completion);
        MEM_WRITE ("MMS_W_SCAN", Master_ID_A[2:0],
               Target_Base_Addr_A[31:0] + 32'h0000000C,
...
// Normal, Retry 0.5, Stop 1, Retry 1.5, Stop 2, Delayed, Abort 0.5, Abort 1.5
        MEM_WRITE ("MMS_W_SCAN", Master_ID_A[2:0],
               Target_Base_Addr_A[31:0] + 32'h00000000,
               32'h01010101, `Test_Eight_Words,
               `Test_No_Master_WS, `Test_No_Target_WS,
               `Test_Devsel_Fast, `Test_Target_Normal_Completion);
        MEM_WRITE ("MMS_W_SCAN", Master_ID_A[2:0],
               Target_Base_Addr_A[31:0] + 32'h00000020,
...
// Do Writes with various termination conditions
        ...
        MEM_WRITE ("MMS_W_SCAN", Master_ID_A[2:0],
               Target_Base_Addr_A[31:0] + 32'h00000014,
        ...
        MEM_WRITE ("MMS_W_SCAN", Master_ID_A[2:0],
               Target_Base_Addr_A[31:0] + 32'h00000024,
...
// Check that memory contains the right stuff
        ...
        MEM_READ ("MMS_R_SCAN", Master_ID_A[2:0],
               ...
               `Test_Devsel_Fast, `Test_Target_Normal_Completion);
        MEM_READ ("MMS_R_SCAN", Master_ID_A[2:0],
               Target_Base_Addr_A[31:0] + 32'h00000010,
        ...
        MEM_READ ("MMS_R_SCAN", Master_ID_A[2:0],
               ...
               `Test_Devsel_Fast, `Test_Target_Normal_Completion);
        MEM_READ ("MMS_R_SCAN", Master_ID_A[2:0],
               Target_Base_Addr_A[31:0] + 32'h00000018,
               32'h1E1E1E1E, `Test_One_Word,
               `Test_No_Master_WS, `Test_No_Target_WS,
               `Test_Devsel_Fast, `Test_Target_Normal_Completion);
        MEM_READ ("MMS_R_SCAN", Master_ID_A[2:0],
               Target_Base_Addr_A[31:0] + 32'h0000001C,
        ...
        MEM_READ ("MMS_R_SCAN", Master_ID_A[2:0],
               ...
               `Test_Devsel_Fast, `Test_Target_Normal_Completion);
        MEM_READ ("MMS_R_SCAN", Master_ID_A[2:0],
               Target_Base_Addr_A[31:0] + 32'h00000028,
...
// Test delayed read activity
        ...
        MEM_READ ("MMS_R_SCAN", Master_ID_A[2:0],  // Verify that Read completes
               Target_Base_Addr_A[31:0] + 32'h00000004,  // Expect error
               32'hFFFFFFFF, `Test_One_Word,
               `Test_No_Master_WS, `Test_No_Target_WS,
               `Test_Devsel_Fast, `Test_Target_Normal_Completion);
...
task exhaustive_config_refs_scan;
  ...
  reg    [31:0] Target_Addr_A_Now;
  reg    [2:0] Master_ID_B_Now;
  reg    [31:0] Target_Addr_B_Now;
  reg    [2:0] Master_ID_Temp;
  reg    [31:0] Target_Addr_Temp;
  ...
  begin
    ...
    Target_Addr_A_Now[31:0] = Target_Config_Addr_A[31:0];
    if (alternate_sources)
    begin
      Master_ID_B_Now[2:0] = Master_ID_B[2:0];
      Target_Addr_B_Now[31:0] = Target_Config_Addr_B[31:0];
    end
    else
    begin
      Master_ID_B_Now[2:0] = Master_ID_A[2:0];
      Target_Addr_B_Now[31:0] = Target_Config_Addr_A[31:0];
    end
    ...
    begin
      ...
      if (select_read)
      begin
        CONFIG_READ  ("CFA_R_SCAN", Master_ID_A_Now[2:0], Target_Addr_A_Now[31:0],
...
// Swap source and destination
      ...
      Target_Addr_A_Now[31:0] = Target_Addr_B_Now[31:0];
      Master_ID_B_Now[2:0] = Master_ID_Temp[2:0];
      Target_Addr_B_Now[31:0] = Target_Addr_Temp[31:0];
    end
  end
endtask
...
task exhaustive_mem_refs_scan;
  input   alternate_sources;
  input  [2:0] Master_ID_A;
  input  [31:0] Target_Addr_A;
  input  [2:0] Master_ID_B;
  input  [31:0] Target_Addr_B;
  reg    [2:0] Master_ID_A_Now;
  reg    [31:0] Target_Addr_A_Now;
  reg    [2:0] Master_ID_B_Now;
  reg    [31:0] Target_Addr_B_Now;
  ...
  begin
    Master_ID_A_Now[2:0] = Master_ID_A[2:0];
    Target_Addr_A_Now[31:0] = Target_Addr_A[31:0];
    for (j = 12'h000; j != 12'h800; j = j + 12'h001)
    begin
      MEM_WRITE ("MMS_W_INIT", Master_ID_A_Now[2:0],
               Target_Addr_A_Now[31:0] + {21'h000000, j[5:0], 2'h0},
    ...
    begin
      Master_ID_B_Now[2:0] = Master_ID_B[2:0];
      Target_Addr_B_Now[31:0] = Target_Addr_B[31:0];
      for (j = 12'h000; j != 12'h040; j = j + 12'h001)
      begin
        MEM_WRITE ("MMS_W_INIT", Master_ID_B_Now[2:0],
                 Target_Addr_B_Now[31:0] + {21'h000000, j[5:0], 2'h0},
                 {2'b00, j[5:0] + 6'h03, 2'b00, j[5:0] + 6'h02,
                  2'b00, j[5:0] + 6'h01, 2'b00, j[5:0] + 6'h00},
                 `Test_One_Word, 8'h00, 8'h00,
                 `Test_Devsel_Fast, `Test_Target_Normal_Completion);
    ...
    begin
      Master_ID_B_Now[2:0] = Master_ID_A[2:0];
      Target_Addr_B_Now[31:0] = Target_Addr_A[31:0];
    end
...
// fire off tasks in response to top-level test bench
  reg    [2:0] Master_ID_A;
  reg    [31:0] Target_Config_Addr_A;
  reg    [31:0] Target_Base_Addr_A0;
  reg    [31:0] Target_Base_Addr_A1;
  reg    [2:0] Master_ID_B;
  reg    [31:0] Target_Config_Addr_B;
  reg    [31:0] Target_Base_Addr_B0;
  reg    [31:0] Target_Base_Addr_B1;

  initial
  begin
    Master_ID_A = `Test_Master_1;
    Target_Config_Addr_A = `TEST_DEVICE_0_CONFIG_ADDR;
    Target_Base_Addr_A0 = 32'h80000000;
    Target_Base_Addr_A1 = 32'h82000000;
    Master_ID_B = `Test_Master_0;
    Target_Config_Addr_B = `TEST_DEVICE_1_CONFIG_ADDR;
    Target_Base_Addr_B0 = 32'h81000000;
    Target_Base_Addr_B1 = 32'h83000000;
...
`endif // REPORT_TEST_DEVICE
      init_config_regs (Master_ID_A[2:0], Target_Config_Addr_A[31:0],
                        Target_Base_Addr_A0[31:0], Target_Base_Addr_A1[31:0]);
...
`endif // REPORT_TEST_DEVICE
      ...
      init_config_regs (Master_ID_B[2:0], Target_Config_Addr_B[31:0],
                        Target_Base_Addr_B0[31:0], Target_Base_Addr_B1[31:0]);
      do_pause( 16'h0008);
      vary_one_paramater_at_a_time (Master_ID_A[2:0], Target_Config_Addr_A[31:0],
                                    Target_Base_Addr_A0[31:0],
                                    Master_ID_B[2:0], Target_Config_Addr_B[31:0],
                                    Target_Base_Addr_B0[31:0]);
    end
